...
const ExtractTextPlugin = require('extract-text-webpack-plugin')  // extract css files from js
...
const htmlConfig = env.NODE_ENV === 'development' ? config.dev : config.build;
...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      staticRoot: htmlConfig.assetsPublicPath,
    ...
    new CopyWebpackPlugin([
      {
        from: path.resolve(__dirname, config.dev.staticRoot),
        to: config.build.assetsSubDirectory,
        ignore: ['lib/base/*'] //忽略base文件夹内容
      }
    ]),
